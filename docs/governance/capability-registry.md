...
|---------------|-------|-------|------|--------------------|--------------------|--------------------|----------------------------|
| `wise.capability.architecture-council` | Architecture Agent | AI Fabric — Architecture Council | [24-architecture-agent.md](../architecture/canonical/24-architecture-agent.md) | Draft | Pending — spec §14 declared, not fleet-registered | ADR-011 freeze; layer/contract model (03 §4, §7); AI Fabric gates (04 §2.2); agent-checks registry | Architecture Office acceptance for gate progression; ADR for freeze exceptions and layer-boundary waivers |
