"""Alembic migration environment for Reference Capability 1."""
...
from wise_reference.base import Base  # noqa: E402
from wise_reference.models import (  # noqa: E402, F401
    DiscoveryRecord,
    EntityAssertion,
    ExternalLink,
    GraphEntity,
...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        version_table="alembic_version_reference",
    )
