...
**Pending** — agent spec benchmark requirements declare benchmarks to be evaluated by [Benchmark Agent](../architecture/canonical/23-benchmark-agent.md); not yet registered in §5.4 fleet.

**Registered** — agent appears in [23-benchmark-agent.md](../architecture/canonical/23-benchmark-agent.md) §5.4 with benchmarks declared in agent §AI Fabric Governance or declared benchmark requirements section.
