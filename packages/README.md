...
| `wise-portfolio-intelligence` | Mission-first portfolio selection integrating commercial appeal with rights and diversity caps |
...
pip install -e packages/wise-common -e packages/wise-contracts -e packages/wise-registry \
  ...
  -e packages/wise-portfolio-intelligence
```
